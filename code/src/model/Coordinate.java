...
/**
 * this class is to create a coordinate in a map the coordinate is defined by 3
 * directions in a panel, which are i, y, z.
 */
public class Coordinate {
     ...
     *
     * @param direction the direction of the new coordinate from the original
     * coordinate
     * @param distance the distance of the new coordinate from the original
     * coordinate
     * @param mapSize the size of map
    ...
    public Coordinate getNewCoordinate(int direction, int distance, int mapSize) throws Exception {
        ...
        switch (direction) {
            case 0:
                newCoordindate.x += distance;
                newCoordindate.y -= distance;
                break;
            case 1:
                newCoordindate.y -= distance;
                newCoordindate.z += distance;
                break;
            case 2:
                newCoordindate.x -= distance;
                newCoordindate.z += distance;
    ...
    /**
     * this method is to override the toString() method to get the string of a
     * coordinate
     *
     ...
     *
     * @param mapSize
     * @return ringMap A hashMap of the key pair of direction and surrounding
     * coordinates.
     */
